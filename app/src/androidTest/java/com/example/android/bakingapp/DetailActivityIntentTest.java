...
public class DetailActivityIntentTest {
    ...
    public void clickRecipe_LaunchDetailActivityIntent() {
        ...
        targetContext.getResources().getBoolean(R.bool.open_in_tablet);
        Boolean isTabletUsed = targetContext.getResources().getBoolean(R.bool.open_in_tablet);
        if (!isTabletUsed) {
        ...
        if (isTabletUsed) {
            ...
            onView(withId(R.id.exo_player_holder)).check(matches(isDisplayed()));
        }
